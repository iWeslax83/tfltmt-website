...
export const projects: Project[] = [
  {
    ...
    members: ["Emir Sakarya", "Demir Özcan", "Erdem Gümüş", "İbrahim Özdemir", "Arda Akalın", "Sualp Çelik", "Ahmet Ege Aksoy", "Berke Azim Açıkkol", "Yusuf Talha Kaya"],
    competitionDate: new Date("2026-09-30"),
    technicalSpecs: [
      { label: "Uçuş Süresi", value: "15-20 dakika" },
      { label: "Maksimum Hız", value: "16.5 m/s" },
      { label: "Yük Kapasitesi", value: "515g" },
      { label: "Maksimum Menzil", value: "12 km"}
      { label: "Uçuş Kontrolcüsü", value: "Pixhawk 6C" },      
    ],
    features: [
  ...
  },
  {
    ...
    members: ["Emir Sakarya", "Demir Özcan", "Erdem Gümüş", "İbrahim Özdemir", "Arda Akalın", "Ahmet Ege Aksoy"],
  ...
  },
  {
    ...
    members: ["Demir Özcan", "Erdem Gümüş", "Emir Sakarya", "Uras Demir Demirci", "Arda Akalın", "İbrahim Özdemir", "Berke Azim Açıkkol"],
